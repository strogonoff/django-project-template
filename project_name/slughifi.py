#coding: utf-8
# Code from
# http://trac.django-fr.org/browser/site/trunk/project/links/slughifi.py
# (Author is Samuel Adam, apparently:
#     https://groups.google.com/forum/#!topic/django-users/WltYWieywVw)
